...
void Agency::menuSearchUserByID() {
	...
	u->setID(id);
	if (sequentialSearch(UsersV, u) != -1)
		pos = sequentialSearch(UsersV, u);
	else {
		ut.setcolor(4); cerr << "> User with that ID not found." << endl; ut.setcolor(15);
		...
		ut.setcolor(3); cout << "-----------------------------------------------------------" << endl;
		ut.white();
		cout << setw(5) << UsersV.at(pos)->getID();
		cout << setw(10) << UsersV.at(pos)->getUsername();
		cout << setw(20) << UsersV.at(pos)->getName();
		cout << setw(10) << setprecision(2) << fixed << UsersV.at(pos)->getBalance();

		if (UsersV.at(pos)->car())
			cout << setw(10) << "[X]" << endl;
		else cout << setw(10) << "[ ]" << endl;
